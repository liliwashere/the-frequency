...
## What This Is
A twice-weekly AI newsletter (thefrequency.lilitarutyunyan.com). Automated pipeline: Tavily search → Claude curation → HTML generation → Cloudflare Pages deploy → Gmail send. Publishes every Tuesday 09:00 Lisbon.
